...
export default function About() {
  return (
    <section
      className="flex items-center py-20 bg-white text-slate-900"
      id="about"
    >
      <Container>
        <motion.div
        ...
        >
          ...
          <p className="mt-8 text-lg max-w-2xl leading-relaxed text-slate-600">
          ...
          <div className="mt-14 grid gap-10 sm:grid-cols-3 text-sm text-slate-700">
            <div className="group">
